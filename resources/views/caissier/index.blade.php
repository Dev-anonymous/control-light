...
@section('body')
    ...
    <div>
        ...
        @php
            ...
            $nf = \App\Models\Facture::where('compte_id', compte_id())->where('users_id', auth()->user()->id)
                ->get()
                ->count();

            $tot = \App\Models\Facture::where('compte_id', compte_id())->where('users_id', auth()->user()->id)
                ->groupBy('devise')
        ...
        <div class="main-content">
            <section class="section">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <a no-under href="{{ route('ventes-magasin.caissier') }}">
                            <div class="card ombre" style="min-height: 200px" data-toggle="tooltip"
